...
const resourceLinks = [
  `Phone: +91 XX XXXXXX`,
  `Email : abc@robotrips.vercel.app`
];
  ...
  <footer className={tw(`bg-white border-t border-gray-400 pt-14 pb-16`)}>
    <div className={tw(`max-w-7xl mx-auto text-gray-400 px-8 lg:px-0 flex flex-wrap`)}>
      <div className={tw(`mb-14 flex items-center w-full`)}>
        <img className={tw(`h-12 w-12 mr-4`)} src="logo.png" alt="logo" width={60} height={60} />
        <p className={tw(`text-4xl text-indigo-500 font-bold`)}>ROBOTRIPS</p>
      </div>
      <div className={tw(`w-full lg:w-1/2`)}>
        <ul className={tw(`text-lg font-light flex flex-wrap w-full`)}>
          ...
          <li className={tw(`w-1/2 md:w-1/3 lg:w-1/3`)}>
            <div>
              <h4 className={tw(`text-gray-900 font-bold mb-1`)}>Contact Us</h4>
              <ul>
