...
const articles = [
  {
    ...
    title: `Our edge computing power is provided by NVIDIA's processors`,
    image: `/images/case-1.webp`,
    alt: `Proident pariatur est.`,
  },
  {
    slug: 'Powered by Nvidia',
    title: `Every robotaxi comes with an NVIDIA computer that supports vehicle ports and sensors.`,
    image: `/images/case-2.webp`,
    alt: `Proident pariatur est.`,
  },
  {
    slug: 'Computer Vision',
    title: `Our team developed algorithms and models tailored to the real-world environment`,
  ...
  <section>
    <div className={tw(`w-full min-h-screen bg-gray-900 relative`)}>
      ...
      <div className={tw(`max-w-7xl mx-4 lg:mx-auto pt-20 lg:pt-40`)}>
        <h1 className={tw(`text-white text-4xl lg:text-7xl font-bold text-center`)}>Our Technology</h1>
            ...
            {articles.map((article) => (
              ...
              >
                ...
                <div className={tw(`p-4 shadow-lg w-full mx-auto -mt-8 bg-white rounded-b z-30 relative`)}>
                  <p className={tw(`uppercase text-sm text-gray-700 text-center pb-1`)}>{article.slug}</p>
